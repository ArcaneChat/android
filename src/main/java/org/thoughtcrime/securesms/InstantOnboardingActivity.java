...
public class InstantOnboardingActivity extends BaseActionBarActivity
  ...
  private void initializeResources() {
    ...
    privacyPolicyBtn.setText(TextUtil.markAsExternal(getString(R.string.terms_n_privacy_policy)));
    final String URL = "https://arcanechat.me/privacy";
  ...
  private void startQrAccountCreation() {
    ...
    String qrCode = TextUtils.isEmpty(providerQrData) ? "dcaccount:arcanechat.me" : providerQrData;
    new Thread(
            () -> {
